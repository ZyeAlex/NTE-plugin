...
class Setting {
  constructor() {
    ...
    // 本插件地址
    this.path = this.yunzaiPath + '/plugins/NTE-plugin'
     ...
     * 角色数据
     */
    this.nicknames = this.getData('data/hero/default_nickname') || {} // 角色昵称  {101003:['111']}
  ...
  async getHeroData() {
    ...
    try {
      ...
      logger.error(`[NTE-plugin][getHeroData]${error}`)
    }
